...
export default function App() {
    ...
    return (ORUI.createElement("orui-grid", null,
        ORUI.createElement("orui-row", null,
            ORUI.createElement("orui-router-provider", { routes: routes, before_change: before_change }))));
}
document.getElementById('root').append(ORUI.createElement(App, null));
