...
export class Selector extends ORUIElement {
    ...
    create() {
        const options_container = ORUI.createElement("div", { class: 'orui-selector-options-container' });
        if (this.columns) {
        ...
        this.options.forEach((option, index) => {
            const option_item = ORUI.createElement("div", { class: 'orui-selector-option-item' });
        ...
        if (!this.container) {
            const container = ORUI.createElement("div", { class: 'orui-selector-container' });
    ...
    create_option_item_description(option_item, content) {
        const description_ctr = ORUI.createElement("div", { class: 'orui-selector-item-description' });
    ...
    create_check_wrap(option_item) {
        const wrap = ORUI.createElement("div", { class: 'orui-check-wrap' });
        const icon = ORUI.createElement("orui-icon", { path: '/components/images/check.svg', color: 'var(--orui-color-fill-content)' });
