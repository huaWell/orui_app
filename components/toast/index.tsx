...
export class Toast extends ORUIElement{
    ...
    init() {
        const html = (
            <>
                <orui-mask visible="false"/>
                <div class="orui-toast-content">
                    <div class="orui-toast-main">
                        <div style="display: none" class="orui-toast-icon"></div>
                        <div class="orui-auto-center">
                            <div class="orui-center-content">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        const mask = html.querySelector('orui-mask') as ORUIElement
        this.mask = mask
    ...
    render() {
        ...
        if(this.icon_path){
            if(!this.icon['_icon']){
                const frag = <orui-icon className="orui-toast-icon"/>
