...
export class TabBar extends ORUIElement{
    ...
    create(){
        const tab_bar_wrap = <div class= 'orui-tab-bar-wrap'/>
    ...
    create_item(){
        ...
        this.data.forEach((_v,index) => {
            const item = <div class='orui-tab-bar-item'/>
            item['name'] = _v.key
            const icon_container = <div class='orui-icon-wrapper'/>
            if(_v.icon){
                const icon = <orui-icon/>
                icon.set_ui({
                    path: _v.icon,
            ...
            const text = <div class='orui-icon-text'/>
