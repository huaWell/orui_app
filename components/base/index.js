    ...
    static getPropertyDescriptor(name) {
        ...
        const init_default = (name, value) => {
            ...
            if (type_name == 'String') {
                ...
                _value = type.indexOf(value) != -1 ? value : return_default_value();
            }
