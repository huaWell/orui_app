...
export class Dropdown extends ORUIElement {
    ...
    // active_extra: string
    init() {
        const template = (ORUI.createElement("div", { class: "orui-dropdown-bar" }));
    ...
    create_dropdown_bar(data, name) {
        const dropdownBarContent = (ORUI.createElement("div", { class: 'orui-dropdown-bar-content' }));
        const title = (ORUI.createElement("div", { class: 'orui-dropdown-bar-title' }));
        if (!this.value[name]) {
        ...
        const rightArrow = (ORUI.createElement("span", { class: 'orui-dropdown-arrow' }));
        ...
        const dropdownItemDown = (ORUI.createElement("div", { class: 'orui-dropdown-item-down' }));
    ...
    init_dropDown_click_event(dropdownBarContent) {
        dropdownBarContent.onclick = (ev) => {
            ...
            if (dropdownItem.innerHTML == "") {
                const html = (ORUI.createElement("div", { class: "orui-dropdown-down" },
                    ORUI.createElement("orui-mask", null),
                    ORUI.createElement("div", { class: "orui-check-list-content" },
                        ORUI.createElement("orui-check-list", null))));
                this._mask = html.querySelector('orui-mask');
                this._mask.addEventListener('click', () => {
                    this.set_dropdown_not_active();
                });
                dropdownItem.appendChild(html);
                const checkList = dropdownItem.querySelector('orui-check-list');
